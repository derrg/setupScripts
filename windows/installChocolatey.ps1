...
[string[]] $programs = @(
    "7zip.install", "adobereader", "audacity", "awscli", "blender", "ccleaner", "cpu-z", "cue", "deluge", "dep",
    "docker", "dotnet4.7", "everything", "firefox", "gifcam", "gimp", "git", "git-lfs", "golang", "googlechrome",
    "gradle", "groovy", "itunes", "jdk11", "jetbrainstoolbox", "k-litecodecpackfull", "kindle", "krita", "kubernetes-cli", "kubernetes-helm"
    "libreoffice", "lmms", "microsoft-windows-terminal", "mingw", "openjdk", "openjdk11", "openssh", "origin",
    "procexp", "python", "quicklook", "r.project", "sharex", "signal", "speccy", "spotify", "steam", "streamlabs-obs", "sysinternals",
